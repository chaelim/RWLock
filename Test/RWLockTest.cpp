...
//===========================================================================
// Using Critical Section to use it as baseline performance and can compare
    ...
    unsigned    threadCount)
{
    ...
    // Wait until all threads are ready and signal to start testing
    ...
    // Collects test result stored in per-thread data
